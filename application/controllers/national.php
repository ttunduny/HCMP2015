...
// 
		...
		//Added function to display oonly the counties that are currently using HCMP
				...
				public function consumption_annual($county_id = null, $district_id = null, $facility_code = null, $commodity_id = null, $graph_type = null, $from = null, $to = null) {
		...
		//print_r($name);exit;
		 ...
		 if($count_commodities>1){
			...
			array_push($row_data, array("The below commodities were consumed $time"));
		 	...
		 	$and_data
		 	group by d.id , f.facility_code
		 	order by c.county asc , d1.district, month asc
		 	");
