  ...
  //  		$header_end .="pause";
   ...
   public function create_core_tables($facility_code,$database=null){
	  	...
	  	ini_set('memory_limit', '-1');
   		...
   		$query = '';
		$handle = fopen($filename, 'w');
		$core_tables = array('access_level','assignments','comments','commodities','commodity_category','commodity_division_details','commodity_source','commodity_source_other','commodity_sub_category','counties','county_drug_store_issues','county_drug_store_totals','county_drug_store_transaction_table','districts','drug_commodity_map','drug_store_issues','drug_store_totals','drug_store_transaction_table','email_listing','email_listing_new','facilities','git_log','issue_type','menu','malaria_drugs','rca_county','recepients','sub_menu','service_points','redistribution_data','receive_redistributions','log','log_monitor','db_sync','facility_order_status','facility_order_details_rejects','facility_order_details','dispensing_records','facility_loggins','facility_rollout_status','inventory','patient_issues','patients','selected_service_points','service_point_stock_physical','status','sync_updates','update_log');
