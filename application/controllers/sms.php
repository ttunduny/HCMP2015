   ...
   // exit;
	...
	//delete the attachment after sending to avoid clog up of pdf'ss
        		...
        		public function new_weekly_usage($year=null,$month=null){
        			...
        			$not_issued_within_month = Facilities::get_facilities_not_logged_in_month($start_date,$end_date,null,null,'issued');
        			...
        			$facilities_offline = Facilities::get_offline_facilities(null,null);
