...
<script>
    ...
    //     }); 
        ...
        //   e.preventDefault();
        //   var url = "<?php echo base_url(); ?>reports/new_system_usage_temp";
        ...
        //   var year = $('#year').val();
        //   var month = $('#month').val();
        //   var url = "<?php echo base_url(); ?>reports/new_system_usage_temp_ajax/";
        ...
        // });
        $("#filter_month_year").on('click', function(){
        var year = $('#year').val();
        var month = $('#month').val();
        var url = 'reports/new_system_usage_temp/'+year+'/'+month+'/1';
        ajax_request_replace_div_content(url,"#data_lists");
        });
